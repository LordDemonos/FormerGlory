...
def process_text_data(text_data, is_spell_inventory, file_name):
    ...
    excluded_items = ['Empty', 'Backpack', 'Elemental Grimoire', "Deluxe Toolbox", "Ivandyr's Hoop", 'A Worn Candle', 'Hand Made Backpack', 'Currency', 'Bread Cakes*', 'Skin of Milk', 'Large Sewing Kit']
