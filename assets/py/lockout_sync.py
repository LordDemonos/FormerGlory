...
SERVER_LOCKOUT_OVERRIDES: dict[str, str] = {
    ...
    "queen_silandria": STANDARD_66H,
    "arch_mage_alchtonion": STANDARD_66H,
    "gakamenial_fir_disralsi": STANDARD_66H,
    "rinturion_windblade": STANDARD_66H,
    "arch_mage_yozanni": STANDARD_66H,
    "babnoxis_the_spider_queen": STANDARD_66H,
    "blazzax_the_omnifiend": STANDARD_66H,
    "criare_sunmane": STANDARD_66H,
    "general_druav_flamesinger": STANDARD_66H,
    "general_reparm": STANDARD_66H,
    "jaxoliz_dawneyes": STANDARD_66H,
    "magmaton": STANDARD_66H,
    "pyronis": STANDARD_66H,
    "quavonis_firetail": STANDARD_66H,
    "mujaki_the_devourer": STANDARD_66H,
    ...
    "faruek_the_bold": STORMS_MINI,
    "paruek_the_strong": STORMS_MINI,
    "laruken_the_rigid": STORMS_MINI,
    "zertuken_the_unyielding": STORMS_MINI,
    "pendubk_the_turbulent": STORMS_MINI,
    "solnebk_the_unruly": STORMS_MINI,
    "auliffe_chaoswind": STORMS_LORD,
    "brynju_thunderclap": STORMS_LORD,
    "eindride_icestorm": STORMS_LORD,
    "kuanbyr_hailstorm": STORMS_LORD,
    "laef_windfall": STORMS_LORD,
    "gaukr_sandstorm": STORMS_LORD,
    "oreen_wavecrasher": STORMS_LORD,
    "hreidar_lynhillig": STORMS_LORD,
