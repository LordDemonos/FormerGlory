---
layout: page
title: Gallows Master Teion
subtitle: Level 65 Guard of Justice Enchanter
cover-img: /assets/img/Gallows-Master-Teion.jpg
---

<div class="info-section">
<div class="info-item"><strong>HP:</strong> 32,300</div>
...
<div class="info-item"><strong>Faction:</strong> KOS&nbsp;&nbsp;&nbsp;<a href="https://www.pqdi.cc/npc/201477" target="_blank" title="View NPC on PQDI">🔗</a></div>
</div>
...
<div class="copy-text-container"><pre class="copy-text-content" id="copy-box">&lt;Gallows Master Teion&gt; - CH Chain: 4sec, 6sec slowed, Hits 720, AE Rampage, Slowable (90% mit), Enchanter, Casts: Gravity Flux and mez/tash/root, 32.3k HP</pre><button class="copy-button" onclick="copyText('copy-box')">Copy to Clipboard</button></div>

Final boss of the [Trial of Suffocation](/strategy/justice_trials) (also called Hanging). Spawns after the waves instead of wraith of agony. Kill him and loot Mark of Suffocation.

Kill **spirit of suffocation** mobs first during the waves or the trial can fail.
