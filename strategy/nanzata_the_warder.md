...
<div class="info-lockoutitem info-lockout-loot"><a href="/raid-loot#nanzata-the-warder" title="View raid loot">🔗</a></div>
</div>
...
<div class="copy-text-container"><pre class="copy-text-content" id="copy-box">&lt;Nanzata the Warder&gt; [Slowable] - [CH Unslowed: 3s, Slowed: 5s] // Frost Breath (PBAOE, 300 rng, CR, 0 check, 12s CD): 500 dmg AOE + 1 slot dispel | **Keep junk buff in top slot**</pre><button class="copy-button" onclick="copyText('copy-box')">Copy to Clipboard</button></div>