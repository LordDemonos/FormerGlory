---
layout: page
title: Punisher of Flame
subtitle: Level 65 Guard of Justice Wizard
cover-img: /assets/img/Punisher-of-Flame.jpg
---
...
<div class="info-item"><strong>Faction:</strong> KOS&nbsp;&nbsp;&nbsp;<a href="https://www.pqdi.cc/npc/201486" target="_blank" title="View NPC on PQDI">🔗</a></div>
</div>
...
<div class="info-lockoutitem info-lockout-loot"><a href="/raid-loot#punisher-of-flame" title="View raid loot">🔗</a></div>
</div>
...
<div class="stats-cell"><strong>Max Damage:</strong> 746</div>
</div>
<div class="stats-row">
...
<div class="copy-text-container"><pre class="copy-text-content" id="copy-box">&lt;Punisher of Flame&gt; - CH Chain: 4sec, 6sec slowed, Hits 746, AE Rampage, Slowable (90% mit), Fire Immune (FR 1000), Casts: Rain of Molten Lava (PBAE, 300 DD, -100 Fire, 12s recast) plus wizard nukes/roots, 32.3k HP</pre><button class="copy-button" onclick="copyText('copy-box')">Copy to Clipboard</button></div>

Final boss of the [Trial of Flame](/strategy/justice_trials). Spawns after four waves. Kill him and loot Mark of Flame.
