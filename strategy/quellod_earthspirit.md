...
resize_images: true
layout: page
title: Quellod Earthspirit
subtitle: Level 65 Drake Rogue
cover-img: /assets/img/quellod_earthspirit.webp
---
...
<div class="info-item"><strong>Faction:</strong> <a href="https://www.pqdi.cc/faction/467" target="_blank">Guardians of Veeshan</a>&nbsp;&nbsp;&nbsp;<a href="https://www.pqdi.cc/npc/124006" target="_blank" title="View NPC on PQDI">🔗</a></div>
</div>
...
<div class="info-lockoutitem info-lockout-loot"><a href="/raid-loot#quellod-earthspirit" title="View raid loot">🔗</a></div>
</div>
...
<div class="spell-cell"><a href="https://www.pqdi.cc/spell/1491" target="_blank">Slime Mist</a></div>
</div>
...
<div class="copy-text-container"><pre class="copy-text-content" id="copy-box">&lt;Quellod Earthspirit&gt; [Slowable, Flurry] - [CH: 2s with Defensive] // Slime Mist (Single, DR, 0 check, 8s CD): 40/tick + 25% slow</pre><button class="copy-button" onclick="copyText('copy-box')">Copy to Clipboard</button></div>
