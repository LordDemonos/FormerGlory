...
cover-img: /assets/img/lord_kreizenn.webp
---
...
<div class="info-item"><strong>Faction:</strong> <a href="https://www.pqdi.cc/faction/467" target="_blank">Guardians of Veeshan</a>&nbsp;&nbsp;&nbsp;<a href="https://www.pqdi.cc/npc/124074" target="_blank" title="View NPC on PQDI">🔗</a></div>
</div>
...
<div class="stats-cell"><strong>Min Damage:</strong> 209</div>
...
<div class="spell-cell"><a href="https://www.pqdi.cc/spell/1479" target="_blank">Wave of Flame</a></div>
</div>
...
<div class="copy-text-container"><pre class="copy-text-content" id="copy-box">&lt;Lord Kreizenn&gt; [Unslowable, hits hard, baneable] - [CH 2s] // Wave of Flame (PBAOE, 375 rng, CR, -100 check, 12s CD): 250 dmg + 1s stun | **Clerics must be in the nook to avoid ministun **</pre><button class="copy-button" onclick="copyText('copy-box')">Copy to Clipboard</button></div>