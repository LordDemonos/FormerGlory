...
resize_images: true
layout: page
title: An Emerald Defender
subtitle: Level 65 Drake Rogue
cover-img: /assets/img/an_emerald_defender.webp
---
...
<div class="info-item"><strong>Faction:</strong> <a href="https://www.pqdi.cc/faction/467" target="_blank">Guardians of Veeshan</a>&nbsp;&nbsp;&nbsp;<a href="https://www.pqdi.cc/npc/124050" target="_blank" title="View NPC on PQDI">🔗</a></div>
</div>
...
<div class="copy-text-container"><pre class="copy-text-content" id="copy-box">&lt;An Emerald Defender&gt; [Slowable, Flurry] - [CH: 2s with Defensive] // Slime Mist (Single, DR, 0 check, 8s CD): 40/tick + 25% slow</pre><button class="copy-button" onclick="copyText('copy-box')">Copy to Clipboard</button></div>
