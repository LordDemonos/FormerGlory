...
layout: page
title: Hedge Maze
subtitle: Plane of Nightmare Event Guide
cover-img: /assets/img/NightmareB-Entrance.png
---

The Hedge Maze flags the raid for The Lair of Terris-Thule. Keep Thelin Poxbourne alive while he walks the maze and collects dagger pieces.

## Access

<a href="/assets/img/NightmareB-Map.png" target="_blank">
  <img src="/assets/img/NightmareB-Map.png" alt="NightmareB-Map"/>
</a>

![NightmareB-Entrance](/assets/img/NightmareB-Entrance.png)
...
Thelin collects dagger pieces around the maze. Waves get larger as he goes. When he reaches the fountain in the center, **[A Construct of Nightmares](/strategy/a_construct_of_nightmares)** spawns.

Loot the Dagger Blade Shard from the construct and give it to Thelin. Hail Thelin to zone out and receive the flag. That flag opens the Lair of Terris-Thule portal in Plane of Nightmares.

<div class="copy-text-container"><pre class="copy-text-content" id="copy-box-construct">&lt;A Construct of Nightmares&gt; - CH Chain: 4sec, 6sec slowed, Hits 1184, Slowable, 300k HP</pre><button class="copy-button" onclick="copyText('copy-box-construct')">Copy to Clipboard</button></div>
