...
<div class="info-lockoutitem info-lockout-loot"><a href="/raid-loot#kalvunar" title="View raid loot">🔗</a></div>
</div>
...
<div class="copy-text-container"><pre class="copy-text-content" id="copy-box">&lt;Kal`Vunar&gt; [Slowable] - [CH: Remedy Spam] // Melee</pre><button class="copy-button" onclick="copyText('copy-box')">Copy to Clipboard</button></div>
