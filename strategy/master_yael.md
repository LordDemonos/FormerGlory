...
layout: page
title: Master Yael
subtitle: Level 56 Elemental Wizard
cover-img: /assets/img/master_yael.webp
---
...
<div class="stats-cell"><strong>Min Damage:</strong> 53</div>
...
<div class="stats-cell"><strong>HP Regen:</strong> 963</div>
...
<div class="copy-text-container"><pre class="copy-text-content" id="copy-box">&lt;Master Yael&gt; Death Touch!</pre><button class="copy-button" onclick="copyText('copy-box')">Copy to Clipboard</button></div>