...
<div class="info-lockoutitem info-lockout-loot"><a href="/raid-loot#telkorenar" title="View raid loot">🔗</a></div>
</div>
...
<div class="copy-text-container"><pre class="copy-text-content" id="copy-box">&lt;Telkorenar&gt; [Slowable, baneable] - [CH 6s] // Lava Breath (PBAOE, 300 rng FR, 0 check, 12s CD): 500 dmg AOE + 1 slot dispel</pre><button class="copy-button" onclick="copyText('copy-box')">Copy to Clipboard</button></div>